...
<body>
    <div class="shadow">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav nav-link">
                        ...
                        <li class="active"><a href="<?= base_url('home/lihat'); ?>">LIHAT PENGADUAN</a></li>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav><!-- /.nav -->
                ...
                <div class="col-md-6 card-shadow form-custom">
                    <form class="form-horizontal" role="form" method="post" action="index.php">
                        <div class="form-group">
                            <label for="nomor" class="col-sm-4 control-label">Nomor Inet</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="glyphicon glyphicon-exclamation-sign"></span></div>
                                    <input type="text" class="form-control" id="nomor" name="nomor" placeholder="Masukkan Nomor Inet">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel-body card-shadow">
                        <h4>Laporan</h4>
                        <hr class="hr-laporan">
                        <a class="media-left" href="#"><img class="img-circle img-sm" src="<?= base_url('assets'); ?>/images/avatar1.png"></a>
                        <div class="media-body">
                            ...
                            <div>
                                ...
                                <div class="media-block comment">
                                    <a class="media-left" href="#"><img class="img-circle img-sm" src="<?= base_url('assets'); ?>/images/avatar2.png"></a>
                                    <div class="media-body">
                                        <div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container">
                <small>Bella Chaerunisa | PENGADUAN KENDALA DATEL PEMALANG</small>
            </div>
        </div>
